...
public class fivePage extends JFrame
{
    ...
    public fivePage(Drafter drafter)
    {
    ...
    {
        setTitle("5-2-3 - " + drafter.getUsername());
    ...
    private void replaceWithPlayerCard(String abrev, Player player, JPanel oldPlace)
    {
        ...
        playerCard.addMouseListener(new MouseAdapter()
        {
            public void mouseClicked(MouseEvent evt)
            {
                ...
                PlayerSelectionDialog dialog = new PlayerSelectionDialog(fivePage.this, positionName, randomPlayers);
                dialog.setVisible(true);
    ...
    private void saveCurrentFormation()
    {
        ...
        {
            formationName = "My 5-2-3 Formation";
        }
