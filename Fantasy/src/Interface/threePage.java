...
public class threePage extends JFrame
{
    ...
    public threePage(Drafter drafter)
    {
    ...
    private void replaceWithPlayerCard(String abrev, Player player, JPanel oldPlace)
    {
        ...
        playerCard.addMouseListener(new MouseAdapter()
        {
            public void mouseClicked(MouseEvent evt)
            {
                ...
                PlayerSelectionDialog dialog = new PlayerSelectionDialog(threePage.this, positionName, randomPlayers);
                dialog.setVisible(true);
    ...
    private void saveCurrentFormation()
    {
        ...
        {
            formationName = "My 3-5-2 Formation";
        }
